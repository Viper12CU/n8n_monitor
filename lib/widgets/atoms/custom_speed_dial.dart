...
class CustomSpeedDial extends StatefulWidget {
  ...
  /// [secondaryLabelBackgroundColor] Changes the background color of the label Material.
  /// The default value is [Colors.white]
  final Color secondaryLabelBackgroundColor;

  /// [secondaryLabelTextColor] Changes the text color of the label.
  /// The default value is [Colors.black]
  final Color secondaryLabelTextColor;
  ...
  CustomSpeedDial({
    ...
    this.secondaryLabelBackgroundColor = Colors.white,
    this.secondaryLabelTextColor = Colors.black,
  ...
  @override
  State createState() => CustomSpeedDialState();
}
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Material(
                    ...
                    color: widget.secondaryLabelBackgroundColor,
                    child: Padding(
                      padding: EdgeInsets.all(9),
                      child: Text(
                        widget.secondaryIconsText?[index] ?? "",
                        style: TextStyle(
                          color: widget.secondaryLabelTextColor,
